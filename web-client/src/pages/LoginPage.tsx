...
export const LoginPage: React.FC = () => {
    ...
    return (
        <div className="w-screen h-screen bg-gradient-to-b from-[#334d85] to-[#12192b] flex justify-center items-center font-[Supercell-Magic] text-white">
            <div className="relative w-full max-w-md p-8 flex flex-col items-center bg-[#223355]/90 rounded-3xl shadow-2xl border-4 border-[#4a6cd6]">
