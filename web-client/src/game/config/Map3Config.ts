...
export const Map3Config = {
    ...
    CROWN_IMAGES: {
        PLAYER_KING: '/magicblock/tower_king_blue.png',
        PLAYER_QUEEN_Left: '/magicblock/tower_archer_blue2.png',
        PLAYER_QUEEN_Right: '/magicblock/tower_archer_blue.png',
        OPPONENT_KING: '/magicblock/tower_king_red.png',
        OPPONENT_QUEEN_Left: '/magicblock/tower_archer_red2.png',
        OPPONENT_QUEEN_Right: '/magicblock/tower_archer_red.png',
    },
    ...
    TOWERS: [
        ...
        },
        {
            ...
            towerCol: 6,
            pixelScale: 0.15,
            texture: 'm3_tower_archer_blue_left',
            gridRow: 28,
            gridCol: 6,
            gridWidth: 3,
            gridHeight: 3
        },
        {
            ...
            towerCol: 17,
            pixelScale: 0.06,
            texture: 'm3_tower_archer_blue_right',
            gridRow: 28,
            gridCol: 17,
            gridWidth: 3,
            gridHeight: 3
        ...
        },
        {
            ...
            towerCol: 6,
            pixelScale: 0.06,
            texture: 'm3_tower_archer_red_left',
            gridRow: 9,
            gridCol: 6,
            gridWidth: 3,
            gridHeight: 3
        },
        {
            ...
            towerCol: 17,
            pixelScale: 0.06,
            texture: 'm3_tower_archer_red_right',
            gridRow: 9,
            gridCol: 17,
            gridWidth: 3,
            gridHeight: 3
